...
export const translations = {
  'pt-br': {
    ...
    footer: {
      ...
      copyright: '© {year} Seu Site. Todos os direitos reservados.',
      proudlyCanadian: 'Orgulhosamente Canadense',
      versionLabel: 'Versão',
    },
    home: {
  ...
  'en-us': {
    ...
    footer: {
      ...
      copyright: '© {year} Your Site. All rights reserved.',
  ...
  'fr-ca': {
    ...
    footer: {
      ...
      copyright: '© {year} Votre Site. Tous droits réservés.',
  ...
  'es-mx': {
    ...
    footer: {
      ...
      copyright: '© {year} Su Sitio. Todos los derechos reservados.',
      proudlyCanadian: 'Orgullosamente Canadiense',
